...
caminho_planilha_processos = os.path.join(diretorio_atual, 'assets', 'processos_tjms.xlsx')
...
class PortalTJMS:
    ...
    def principal(self) -> None:
        ...
        url_pesquisa = 'https://esaj.tjms.jus.br/cpopg5/search.do?conversationId=&cbPesquisa=DOCPARTE&dadosConsulta.valorConsulta=11669325000188&cdForo=-1&'
    ...
    def obtem_processos(self, url_pesquisa: str) -> list:
        ...
        logger.success(f"Obtendo processo do TJMS")
        ...
        if 'processo.numero' not in url_pesquisa:
            ...
            while processos_obtidos != processos_totais:
                ...
                for processo in processos:
                    ...
                    if link_processo in links_processos:
                        continue
...
if __name__ == '__main__':
    ...
    portal_tj_ms = PortalTJMS(driver=driver)

    portal_tj_ms.principal()
    #portal_tj_sp.main()
