...
caminho_planilha_processos = os.path.join(diretorio_atual, 'assets', 'processos_tjac.xlsx')
...
class PortalTJAC:
    ...
    def principal(self) -> None:
        ...
        url_pesquisa = 'https://esaj.tjac.jus.br/cpopg/search.do;jsessionid=C9EA03C2A84EFAE7F3FE273383957197.cpopg2?conversationId=&cbPesquisa=DOCPARTE&dadosConsulta.valorConsulta=11669325000188&cdForo=-1'
    ...
    def obtem_processos(self, url_pesquisa: str) -> list:
        ...
        logger.success(f"Obtendo processo do TJAC")
...
if __name__ == '__main__':
    ...
    portal_tj_ac = PortalTJAC(driver=driver)
